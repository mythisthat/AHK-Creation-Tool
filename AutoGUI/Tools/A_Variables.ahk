; A_Variables - AutoHotkey Built-in Variables v1.1.1
...
; Search icon
Gui Add, Picture, hWndhSearchIcon x165 y1 w16 h16, ..\Icons\Search.ico
DllCall("SetParent", "UInt", hSearchIcon, "UInt", hSearchField)
...
GuiSize:
    ...
    AutoXYWH("wh", hLV)
    AutoXYWH("wy*", hTV)
    AutoXYWH("y" , hSearchField)
    AutoXYWH("y" , hSearchIcon)
    WinSet Redraw,, ahk_id %hSearchIcon%
Return
