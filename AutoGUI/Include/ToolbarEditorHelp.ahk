...
<body>
    ...
    <dl>
        ...
        <dt>Flat</dt>
        <dd>This style is needed to show separators.</dd>

        <dt>List</dt>
        <dd>Omit this style to show the button text under the button icon.</dd>

        <dt>Show Text</dt>
        <dd>Creates a toolbar with button text to the right of the icon. Use in combination with LIST.</dd>

        <dt>Text Only</dt>
        <dd>Creates a toolbar that resembles a menu bar.</dd>
    ...
    <dl>
        ...
        <dt>WHOLEDROPDOWN</dt>
        <dd>Specifies that the button will have a drop-down arrow, but not as a separate section.</dd>
