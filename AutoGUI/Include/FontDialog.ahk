ShowFontDialog:
    If !(IsWindowVisible(hFontDlg)) {
        ...
        Gui Add, ListView, vFontColorPreview gChooseFontColor x453 y14 w16 h16 -Hdr +Border +BackgroundBlack AltSubmit
        Gui Add, ComboBox, vCbxFontColor gDisplayFontColor x365 y38 w106, Black||0x003399
        Gui Add, ListBox, vLbxFontColor gDisplayFontColor x365 y66 w107 h184 +0x100, Black|Blue|Navy|Green|Teal|Olive|Maroon|Red|Purple|Fuchsia|Lime|Yellow|Aqua|Gray|Silver|White
        ...
        Gui Add, DropDownList, vCbxQuality gCheckQuality x191 y227 w100 AltSubmit, Default||Draft|Proof|Non-antialiased|Antialiased|Cleartype
...
ShowAllFonts:
    ...
    If (g_ShowAllFonts) {
        hDC := DllCall("GetDC", "Ptr", DllCall("GetDesktopWindow"), "Ptr")
